...
const JobPostingList = () => {
  ...
  const fetchJobPostings = async () => {
    setLoading(true);
    const resp = await GetRealApi("JobPosting", navigation);
  ...
  const handleSearch = (text) => {
    ...
    const ft = jobPostings.filter(item =>
  ...
  const openDetail = async (id) => {
    ...
    const resp = await GetRealApi(`JobPosting/${id}`, navigation);
    setSelectedJob(resp);
  ...
  const renderItem = ({ item }) => (
    <View style={styles.cardContainer}>
      ...
      <Text style={styles.value}>Aslan</Text>
      ...
      <View style={styles.iconRow}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("JobPostingCreate", { id: item.id })}
  ...
  return (
    <View style={styles.fullPage}>
      <View style={styles.topBar}>
        ...
        />
        <TouchableOpacity style={styles.downloadBtn} onPress={() => {/* TODO: indir */}}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.dispatch(
              StackActions.push("JobPostingCreate")
            )
          }
        >
              ...
              <ScrollView>
                ...
                {selectedJob && (
                  <>
                    ...
                    <Text style={styles.value}>
                      {selectedJob.isApproved ? "Onaylı" : "Onaysız"}
                    </Text>

                    <Text style={styles.label}>Cinsiyet</Text>
                    <Text style={styles.value}>
                      {getEnumText("Genders", selectedJob.gender)}
                    </Text>
                    ...
                    <Text style={styles.value}>
                      {getEnumText(
                        ...
                        selectedJob.militaryServiceStatus
                      )}
                    </Text>

                    <Text style={styles.label}>Sürücü Belgesi</Text>
                    <Text style={styles.value}>
                      {getEnumText("DriversLicenseClasses", selectedJob.driversLicenseClass)}
                    </Text>

                    <Text style={styles.label}>Min. Deneyim</Text>
                    <Text style={styles.value}>
                      {getEnumText("ExperienceStatuses", selectedJob.minExperience)}
                    </Text>

                    <Text style={styles.label}>Aktif Mi?</Text>
                    <Text style={styles.value}>
                      {selectedJob.isActive ? "Evet" : "Hayır"}
                    </Text>
